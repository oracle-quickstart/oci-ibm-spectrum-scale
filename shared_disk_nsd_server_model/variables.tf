...
variable "BastionNodeShape" { default = "VM.Standard2.2" }
...
variable "ServerNodeCount" { default = "3" }
variable "ServerNodeShape" { default = "BM.Standard2.52" }
...
variable "ComputeNodeShape" { default = "VM.Standard2.24" }
...
variable "GPFSMgmtGUINodeCount" { default = "1" }
variable "GPFSMgmtGUINodeShape" { default = "VM.Standard2.4" }
variable "GPFSMgmtGUINodeHostnamePrefix" { default = "ss-mgmt-gui-" }
...
variable "scripts_directory" { default = "../shared_disk_nsd_server_model_scripts" }
